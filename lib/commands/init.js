 ...
 */
async function initSddStructure(projectRoot) {
  try {
    ...
    // Create L4:purpose spec placeholder
    const projectName = path.basename(projectRoot);
    const purposeSpec = sdd.generateSpec(4, {
      title: projectName,
      purpose: 'Define your project purpose here'
    });
    ...
    const telosEntry = sdd.generateTelosEntry({
      ...
      purpose: 'Define your project purpose'
    });
...
async function initCommand(options) {
  ...
  try {
    ...
    await initSddStructure(projectRoot);
